...
import os
import nltk.corpus
nltk_data_relpath = '../../../model/nltk'
nltk_data_abspath = os.path.abspath(os.path.join(os.path.dirname(__file__), nltk_data_relpath))
nltk.data.path.insert(0, nltk_data_abspath)
